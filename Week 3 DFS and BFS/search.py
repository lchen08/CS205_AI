...
def search_structure(structure, problem):
    ...
    successors = problem.getSuccessors(start_position)

    """
    The start state's formatting differs from its successor. Thus, push start's 
    successors outside the while loop separately from successor's successors.
    """
